...
data class RadarStatus(
    ...
    val squadSelectionAttempts: Long = 0,
    val squadSelectionSuccesses: Long = 0,
    val squadSelectionFailures: Long = 0,
    val sendAttempts: Long = 0,
    val sendVerifiedSuccesses: Long = 0,
    ...
    val squadDiagnostics: String? = null,
